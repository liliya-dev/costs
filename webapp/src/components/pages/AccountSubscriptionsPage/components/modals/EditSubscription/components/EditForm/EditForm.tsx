...
import { Currency, ISubscription, ITag } from '@/types';
...
const EditForm = forwardRef<EditFormRef, IProps>(
  ({ toggleIsDisabled, subscription, callback, accountId }, ref) => {
    ...
    const initialValues: FormValues = {
      ...
      approximatelyPaymentDay: subscription.approximatelyPaymentDay,
