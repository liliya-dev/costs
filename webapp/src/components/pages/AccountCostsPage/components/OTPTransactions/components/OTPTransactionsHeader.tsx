...
const headers = ['Name', 'Amount', 'UAH-USD', 'UAH-EUR', 'Date paid', 'Description', 'Tags'];

interface IProps {
  selectedCurrency: Currency;
}

const OTPTransactionsHeader = ({ selectedCurrency }: IProps) => (
...
export default OTPTransactionsHeader;
