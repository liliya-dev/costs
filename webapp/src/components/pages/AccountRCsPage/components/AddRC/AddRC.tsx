...
const AddRC = ({ accountId, callback }: IProps) => {
    ...
    <div className="flex w-full justify-end">
      ...
      {isOpened && (
        <FullScreenModal
          ...
          title="Add new recurring charge"
          text="Based on the provided information, the new recurring charge will be added to your monthly expenses."
          confirmBeforePrimaryAction={true}
          confirmTitle="Are you sure you want to save this recurring charge?"
          confirmText="Yes"
