...
const AddPBI = ({ accountId, callback }: IProps) => {
    ...
    <div className="flex w-full justify-end">
      ...
      {isOpened && (
        <FullScreenModal
          ...
          text="Based on the provided information, the new payment by installments will be created and included in your monthly expenses."
          confirmBeforePrimaryAction={true}
          confirmTitle="Are you sure you want to save this payment by installments?"
          confirmText="Yes"
