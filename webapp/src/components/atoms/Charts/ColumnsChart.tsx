...
const ColumnsChart = ({ title }: IProps) => {
  const series = [
    {
      name: 'Visitors',
  ...
  return (
    <div className="h-full rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
      <div className="flex justify-between border-b border-stroke px-6 pb-4.5 pt-5.5 dark:border-dark-3">
        <div>
          <h2 className="mb-1.5 text-body-2xlg font-bold text-dark dark:text-white">{title}</h2>
      ...
      <div className="h-3/4 px-6 pb-1 pt-7.5">
        <div id="ColumnsChart" className="-ml-3.5 h-full">
